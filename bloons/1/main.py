...
"""
def loadSounds(app): 
    # Use simple relative paths - cmu_graphics Sound can handle them directly
    app.poppingSound = Sound('sounds/popping_sound.mp3')
    app.music = Sound('sounds/bloons_td_music.mp3')
    app.cannonSound = Sound('sounds/bomb_tower_sound.mp3')
